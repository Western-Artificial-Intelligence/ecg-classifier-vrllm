  ...
  const faqs = [
    {
      ...
      answer: 'No. NeuralApnea Triage is a screening and triage tool, not a diagnostic device. It helps clinicians prioritize high-risk patients for PSG referral and reduce diagnostic delays. A positive result should always be confirmed with full polysomnography.'
    },
    {
